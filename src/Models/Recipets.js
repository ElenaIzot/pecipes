const recipes = [
  ...
  },
  {
    ...
    portions: 4,
    ingridients: [
      { 'name': 'Спагетти', 'count': 1/2, 'measure': 'пачки', },
...

  {
    ...
    ingridients: [
      ...
      { 'name': 'Соль', 'measure': 'на кончике ножа', }
    ],
  ...
  },
  {
    ...
    ingridients: [
      ...
      { 'name': 'Сода', 'count': 1/2, 'measure': 'чайной ложки', },
      { 'name': 'Соль', 'measure': 'на кончике ножа', }
    ],
  ...
  
  {
    ...
    ingridients: [
      ...
      { 'name': 'Растительное масло', 'count': 1/4, 'measure': 'стакана'},
...
export function getRecipe(id) {
  const copyFrom = recipes[id % recipes.length];
